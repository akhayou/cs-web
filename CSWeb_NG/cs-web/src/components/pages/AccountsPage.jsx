...
import DescriptorForm from './composites/DescriptorForm.jsx';
...
export default function AccountsPage({ t, isMobile, onBack, logout, isRTL = false, routerKey = null }) {
    ...
    const seeds = JSON.parse(sessionStorage.getItem('seeds') || '[]');
                ...
                <form ref={formRef} noValidate onSubmit={(e) => e.preventDefault()}>
                    <div className="page-form-grid">
                        ...
                        <div className="page-form-col">
                            ...
                            {/* Final account */}
                            <div className="form-field">
                                <label className="form-label">{t ? t('inputs.finalAccount') : 'Final Account'}</label>
                                <div className="form-select-wrap">
                                    <Select
                                        styles={selectStyles(isRTL)}
                                        isClearable
                            ...
                            <div className="form-field">
                                <label className="form-label">{t ? t('labels.accountNature') : 'Account Nature'}</label>
